...
public interface TatuagemRepository extends JpaRepository<Tatuagem, Integer> {
    @Query("select new br.com.bandtec.ink4yousembanco.model.Tatuagem(t.id_tatuagem, t.titulo, t.local_tatuagem, t.descricao, t.id_tatuador) from Tatuagem t where t.id_tatuador = ?1")
